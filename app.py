...
# Inject absolute clean layout strings explicitly 
st.markdown(
    f"""
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <style>
            ...
            * {{
            ...
            /* Hide default Streamlit file uploader visually */
        ...
        <div class="container">
            ...
            <div>
                ...
                <div class="panel">
                    ...
                    <!-- State 1: Selection Interface -->
                    <div id="upload-state" style="display: {'block' if st.session_state.uploaded_image is None else 'none'};">
                    ...
                    <!-- State 2: Active Image State -->
                    <div id="active-state" style="display: {'none' if st.session_state.uploaded_image is None else 'block'};">
                        <div class="btn-row">
                        ...
                        <div class="image-container">
                            ...
                            <div class="image-caption">Source alignment geometry ({st.session_state.image_name})</div>
                        </div>
                    </div>
            ...
            <div>
                ...
                <div id="output-awaiting" class="placeholder-text" style="display: {'none' if st.session_state.run_analysis else 'block'};">
                    Awaiting image upload and analysis loop.
                </div>

                <div id="output-results" class="panel" style="display: {'block' if st.session_state.run_analysis else 'none'};">
